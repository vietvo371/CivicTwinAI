      ...
      <footer className="relative z-10 border-t border-white/5 py-12 mt-20 backdrop-blur-lg bg-[#020617]/50">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-slate-500 font-medium tracking-wide">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            <span className="hover:text-slate-300 cursor-pointer transition-colors">{t('landing.privacyPolicy')}</span>
            <span className="hover:text-slate-300 cursor-pointer transition-colors">{t('landing.termsOfService')}</span>
            <span className="hover:text-slate-300 cursor-pointer transition-colors">{t('landing.systemStatus')}</span>
          </div>
        </div>
      </footer>
    </div>
